...
Assert: Assert that the returned value is true indicating that a path was found.
Validation: 
...
Act: Invoke setWay method with the map and start coordinates (1,1).
Assert: Assert that the returned value is false indicating that no path was found.
Validation: 
