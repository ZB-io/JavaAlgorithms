...
public class FloodFillGetPixelTest {
	...
	public void validateOutOfBoundsPixel() {
		...
		assertThrows(ArrayIndexOutOfBoundsException.class, () -> FloodFill.getPixel(image, 3, 3),
				"An ArrayIndexOutOfBoundsException should be thrown for out-of-bound coordinates.");
	}
	...
	public void validateNegativePixelCoordinates() {
		...
		assertThrows(ArrayIndexOutOfBoundsException.class, () -> FloodFill.getPixel(image, -1, -1),
				"An ArrayIndexOutOfBoundsException should be thrown for negative coordinates.");
	}
	...
	public void validateNullImage() {
		// Act and Assert
		assertThrows(NullPointerException.class, () -> FloodFill.getPixel(null, 0, 0),
				"A NullPointerException should be thrown for a null image.");
	}
